<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QABugs.aspx.cs" Inherits="Database_Project.QABugs" %>
...
<body>
    ...
    <h5 class="info-title">Setting the standards in design</h5>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
          AutoGenerateColumns="False" CellPadding="4" AutoGenerateSelectButton = "true"
          DataKeyNames="BugID" DataSourceID="SqlDataSource1"
          ...
          <Columns>
            ...
            <asp:BoundField DataField="BugHistoryID" HeaderText="BugHistoryID" 
              SortExpression="BugHistoryID" InsertVisible="False" ReadOnly="True"  Visible = "false"/>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ConnectionString="<%$ ConnectionStrings:Bug_TrackerConnectionString %>" 
            ...
            SelectCommand="QAGrid" SelectCommandType="StoredProcedure">
        </asp:SqlDataSource>
        
        <asp:Label ID="lblRow" runat="server" Text="" ></asp:Label>
      
        <asp:Button ID="btnModify" runat="server" Text="Modify Bug" Visible="false" 
