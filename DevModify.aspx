<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DevModify.aspx.cs" Inherits="Database_Project.DevModify" %>
...
<body>
    ...
    <h5 class="info-title">Setting the standards in design</h5>
        ...
        <br />
        <asp:Label ID="lblReassign" runat="server" Text="Reassign"></asp:Label>
        <asp:Label ID="lblSeverity" runat="server" Text="Bug Severity" style="left: 244px; position: relative;"></asp:Label>
        <br />       
        <asp:DropDownList ID="DropDownList1" runat="server" 
            DataSourceID="LinqDataSource1" DataTextField="FullName" 
        ...
        <asp:DropDownList ID="ddlSeverity" runat="server" width="76px" style="left: 142px; position: relative;">
